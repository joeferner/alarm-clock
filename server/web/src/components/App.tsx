    ...
    private renderContents() {
        if (this.state.hash) {
            if (this.state.hash == '#wunderground') {
                return (<WundergroundExpanded wundergroundService={this.wundergroundService}/>);
            }

            return (<div>Unhandled Hash: {this.state.hash}</div>);
        }
        ...
        return (<table style={this.styles.table}>
            ...
            <tr>
                <td style={this.styles.tableCell}>
                    <div style={this.styles.secondaryWidgetContainer}><Wunderground
                        wundergroundService={this.wundergroundService}/></div>
                </td>
                <td style={this.styles.tableCell}>
